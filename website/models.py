...
class DatabaseLayananKjpBaru(db.Model, UserMixin):
    id = db.Column(db.Integer, primary_key=True)
    tanggal_surat = db.Column(db.String(100))
    pemohon_nama = db.Column(db.String(150))
    pemohon_alamat = db.Column(db.Text)
    pemohon_rt_rw = db.Column(db.String(20))
    pemohon_kelurahan = db.Column(db.String(100))
    pemohon_kecamatan = db.Column(db.String(100))
    pemohon_kota = db.Column(db.String(100))
    pemohon_kode_pos = db.Column(db.String(10))
    pemohon_telpon = db.Column(db.String(20))
    peserta_didik_nama = db.Column(db.String(150))
    peserta_didik_tempat_lahir = db.Column(db.String(100))
    peserta_didik_tanggal_lahir = db.Column(db.String(100))
    peserta_didik_jenis_kelamin = db.Column(db.String(20))
    peserta_didik_alamat = db.Column(db.Text)
    peserta_didik_rt_rw = db.Column(db.String(20))
    peserta_didik_kelurahan = db.Column(db.String(100))
    peserta_didik_kecamatan = db.Column(db.String(100))
    peserta_didik_kota = db.Column(db.String(100))
    peserta_didik_kode_pos = db.Column(db.String(10))
    sekolah_nama = db.Column(db.String(150))
    sekolah_alamat = db.Column(db.Text)
    sekolah_rt_rw = db.Column(db.String(20))
    sekolah_kelurahan = db.Column(db.String(100))
    sekolah_kecamatan = db.Column(db.String(100))
    sekolah_kota = db.Column(db.String(100))
    sekolah_kode_pos = db.Column(db.String(10))
    sekolah_kk = db.Column(db.String(255))
    ...
    pernyataan_nisn = db.Column(db.String(10))
    pernyataan_kelas = db.Column(db.String(10))
    pernyataan_sekolah = db.Column(db.String(100))
    pernyataan_nama_orang_tua = db.Column(db.String(200))
    pernyataan_alamat = db.Column(db.Text)
    pernyataan_ttd_orang_tua = db.Column(db.String(255))
    pernyataan_ttd_penerima = db.Column(db.String(255))
