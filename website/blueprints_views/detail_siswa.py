...
def info(id):
    ...
    # nilai_siswa = DatabaseNilaiSiswa.query.filter_by(nisn_siswa=database_siswa.nisn).first()
    nilai_siswa = DatabaseLegerSiswa.query.filter_by(nisn=database_siswa.nisn).first()
