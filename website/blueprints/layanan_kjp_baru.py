...
def layanan_kjp_baru():
    if request.method == "POST":
        ...
        "pemohon_rt_rw" : request.form.get("pemohon_rt_rw"),
        ...
        "pemohon_kode_pos" : request.form.get("pemohon_kode_pos"),
        "pemohon_telpon" : request.form.get("pemohon_telpon"),
        ...
        "peserta_didik_kode_pos" : request.form.get("peserta_didik_kode_pos"),
        ...
        "sekolah_kode_pos" : request.form.get("sekolah_kode_pos"),
        ...
        "pernyataan_nisn" : request.form.get("pernyataan_nisn"),
        ...
        data_kjp = DatabaseLayananKjpBaru(
            ...
            peserta_didik_rt_rw = fields["peserta_didik_rt_rw"],
            ...
            peserta_didik_kode_pos = fields["peserta_didik_kode_pos"],
            sekolah_nama = fields["sekolah_nama"],
            sekolah_alamat = fields["sekolah_alamat"],
            sekolah_rt_rw = fields["sekolah_rt_rw"],
            ...
            pernyataan_nisn = fields["pernyataan_nisn"],
